...
RULES_TEXT = (
    ...
    "3️⃣ Необходим Новый счёт, и хотя бы 1 сделанная ставка на ЧМ2026 в одной из БК:\n"
    "- <a href=\"https://clck.ru/3MTUvS\">БК Мелбет</a>\n"
    "- <a href=\"https://clck.ru/3MdHXU\">БК Pari</a>\n"
    "- <a href=\"https://clck.ru/33pxSW\">БК Зенит</a>\n"
    "- <a href=\"https://clck.ru/3U4GjU\">Не из РФ</a>\n\n Если уже есть счет в каких-либо из указанных БК, "
    "заводите там, где нет. Это список проверенных и Легальных БК в РФ. + Топовые Бонусы в них на ЧМ 2026!\n\n"
    "4️⃣ Вы можете получить дополнительно 1 балл к рейтингу за приглашение нового игрока, при условии выполнения им "
    "всех правил. Для приглашение игроков Используйте свою реферальную ссылку. Ваша реферальная ссылка находится в "
    "МЕНЮ (кнопка слева)\n\n"
